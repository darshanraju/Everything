    ...
    <Card className="soft-card rounded-3xl border-0 ring-1 ring-primary/10">
      ...
      <CardContent className="flex flex-col gap-4">
        ...
        <Button
          type="button"
          size="lg"
          className="h-14 w-full rounded-full bg-white text-base font-bold text-foreground shadow-md ring-1 ring-primary/15 hover:bg-soft-rose"
          disabled={loading}
        ...
        <p className="text-center text-sm leading-relaxed text-muted-foreground">
          After you sign in once, the app stays signed in on this phone.
        </p>
      </CardContent>
    </Card>
  );
